...
class ProductModal extends Component {
    ...
    render() { 
        ...
        const {wishlists, id, action, product} = this.props;
        return ( 
        ...
        <div className="modal-dialog modal-dialog-centered">
            ...
            <div className="modal-header">
                <h5 className="modal-title" id="staticBackdropLabel">{action === "edit" ? "Edit" : "Add"} Product</h5>
...
export default connect(mapStateToProps, {GETPRODUCTS, SELECTPRODUCT})(ProductModal);